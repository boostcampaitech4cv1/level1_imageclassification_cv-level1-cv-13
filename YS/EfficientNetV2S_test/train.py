...
def train(data_dir, model_dir, args):
    ...
    train_set_indices = train.indices
    val_set_indices = val_set.indices
    

    # print(val_set_indices)

    val_dataset = torch.utils.data.Subset(dataset, val_set_indices)
    
    print(type(val_dataset))
    print(val_dataset.indices == val_set.indices)
    

    # import csv
    # item = val_set.indices
