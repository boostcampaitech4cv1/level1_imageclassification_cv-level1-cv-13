        ...
        with torch.no_grad():
            ...
            for val_batch in val_loader:
                ...
                if figure is None:
                    ...
                    figure = grid_image(
                        inputs_np, labels, preds, n=16, shuffle=args.agedataset != "MaskSplitByProfileDataset"
                    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--maskdataset', type=str, default='MaskDataset', help='dataset augmentation type (default: MaskBaseDataset)')
    parser.add_argument('--genderdataset', type=str, default='GenderDataset', help='dataset augmentation type (default: MaskBaseDataset)')
    ...
    parser.add_argument("--resize", nargs="+", type=list, default=[128, 128], help='resize size for image when training')
